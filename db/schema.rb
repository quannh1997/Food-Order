...
ActiveRecord::Schema.define(version: 20191211055945) do
  ...
  create_table "order_restaurants", force: :cascade do |t|
    ...
    t.datetime "created_at",    null: false
    t.datetime "updated_at",    null: false
    t.index ["order_id"], name: "index_order_restaurants_on_order_id"
    t.index ["restaurant_id"], name: "index_order_restaurants_on_restaurant_id"
  end
